...
public class ProdutoController {
    ...
    public ResponseEntity<ProdutoResponse> readProduto(@PathVariable UUID id) {
        ...
        //@PathVariable -> url/produtos?id=1
        //@ResquestParam -> url/produtos/1
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
                    description = "Página de produtos retornado com sucesso!",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProdutoController.class))),
    ...
    @Operation(summary = "Atualiza o produto específico")
    @PutMapping
